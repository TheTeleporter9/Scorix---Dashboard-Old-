...
class TournamentApp(tk.Tk):
    ...
    def apply_theme(self):
        # Delegate theme application to the settings tab
        if hasattr(self, 'settings_tab'):
            self.settings_tab.apply_theme_to_widgets() # New method in SettingsTab
        else:
            # Fallback for initial theme application before settings_tab is fully initialized
    ...
    def create_widgets(self):
        ...
        self.settings_tab = SettingsTab(self.settings_frame, self.app_state, self.apply_theme) # Pass apply_theme callback
